...
sed -i "s/   - OpenVPN                 : TCP $ovpn, UDP $ovpn2, SSL 992/   - OpenVPN                 : TCP $vpn, UDP $ovpn2, SSL 442/g" /root/log-install.txt
...
sed -i "s/   - OpenVPN                 : TCP $ovpn, UDP $ovpn2, SSL 992/   - OpenVPN                 : TCP $ovpn, UDP $vpn, SSL 442/g" /root/log-install.txt
echo -e "\e[032;1mPort $vpn modified successfully\e[0m"
else
echo "Port $vpn is used"
fi
