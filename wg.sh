...
echo -e "${Info} Wireguard VPS AutoScript By JOESATRIA22"
...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/Gashakgeneration22/Jojo-vpn/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/Gashakgeneration22/Jojo-vpn/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/Gashakgeneration22/Jojo-vpn/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/Gashakgeneration22/Jojo-vpn/main/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
