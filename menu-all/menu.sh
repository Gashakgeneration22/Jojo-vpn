...
;;
28)
rm -rf paket.sh && apt install curl && wget https://raw.githubusercontent.com/Gashakgeneration22/Jojo-vpn/main/menu-all/paket.sh && apt install dos2unix && dos2unix paket.sh && chmod +x paket.sh && ./paket.sh
;;
29)
